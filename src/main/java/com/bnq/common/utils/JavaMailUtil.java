    ...
    public static void main(String[] args) throws Exception {
        ...
        Authenticator auth = new Authenticator() {
            public PasswordAuthentication getPasswordAuthentication(){
                return new PasswordAuthentication("LJ0000276", "1234@abcd");//要使用工号，不能使用邮箱名认证
            }
        };
        ...
        fileBodyPart
            .attachFile("C:\\Users\\lj0000276\\Downloads\\行政区划清单 V3.0 9.03.xlsx","application/octet-stream",null);
