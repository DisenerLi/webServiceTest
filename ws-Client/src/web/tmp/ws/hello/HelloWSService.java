 ...
 * 
 */
@WebServiceClient(name = "HelloWSService", targetNamespace = "http://www.tmp.web/ws/hello", wsdlLocation = "http://127.0.0.1:8080/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8080/services/HelloWorld?wsdl");
