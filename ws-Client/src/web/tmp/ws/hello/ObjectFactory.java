 ...
 * generated in the web.tmp.ws.hello package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://www.tmp.web/ws/hello", "sayHelloWorldFrom");
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://www.tmp.web/ws/hello", "sayHelloWorldFromResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.tmp.ws.hello
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tmp.web/ws/hello", name = "sayHelloWorldFrom")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tmp.web/ws/hello", name = "sayHelloWorldFromResponse")
